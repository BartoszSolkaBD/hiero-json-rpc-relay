...
| [debug_getRawTransaction](https://geth.ethereum.org/docs/interacting-with-geth/rpc/ns-debug#debuggetrawtransaction)   | **Implemented** - Requires `DEBUG_API_ENABLED=true`                              | Mirror Node  | Returns RLP-encoded transaction or 0x if not found      |
